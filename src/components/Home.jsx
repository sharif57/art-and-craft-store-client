...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div className="mt-8">
                <h1 className="lg:text-5xl text-2xl text-center font-extrabold mb-8  bg-gradient-to-r from-pink-600 via-blue-900 to-blue-500 text-transparent bg-clip-text animate-gradient ">Art &Craft Categories Section</h1>
                <p className="lg:w-1/2 mt-4 mx-auto text-center mb-5">Arts and crafts is a category of applied arts, which is a section of handicrafts and manufacturing that includes visual arts.</p>
