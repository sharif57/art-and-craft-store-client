                    ...
                    <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
                        <div className="rounded-lg shadow-md hover:shadow-xl bg-gray-50 p-6  sm:p-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-0.5 text-lg font-medium text-gray-900">Sharif Mahamud</p>
                                </div>
                            </div>
                        ...
                        <blockquote className="rounded-lg shadow-md hover:shadow-xl bg-gray-50 p-6  sm:p-8">
                            <div className="flex items-center gap-4">
                                <img
                                    alt=""
                                    src="https://i.ibb.co/thNvxhc/young-bearded-man-with-striped-shirt.jpg"
                                    className="size-14 rounded-full object-cover"
                                />
                                ...
                                <div>
                                    ...
                                    <p className="mt-0.5 text-lg font-medium text-gray-900">Jowel Rana</p>
                                </div>
                            </div>
                        ...
                        <blockquote className="rounded-lg shadow-md hover:shadow-xl bg-gray-50 p-6 sm:p-8">
                            <div className="flex items-center gap-4">
                                <img
                                    alt=""
                                    src="https://i.ibb.co/L9R4Pfg/bohemian-man-with-his-arms-crossed.jpg"
                                    className="size-14 rounded-full object-cover"
                                />
                                ...
                                <div>
                                    ...
                                    <p className="mt-0.5 text-lg font-medium text-gray-900">Lemon Sikder</p>
                                </div>
                            </div>

                            <p className="mt-4 text-gray-700">
                                Monitor reviews regularly: Keep track of reviews on various platforms and respond promptly to both positive and negative feedback.
